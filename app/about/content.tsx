    ...
    return (
        <div className={paragraph()}>
            ...
            <section className={paragraph()}>
                <h2>Current Role</h2>
                <p>
                    Currently, I am an AI/ML Engineer at Lockheed Martin, where I develop machine learning models tailored for advanced sensing applications in the defense sector. My work involves extensive research and application of XGBoost models, creating efficient pipelines, and implementing these solutions to enhance the capabilities of edge devices and vehicles.
                </p>
            </section>
